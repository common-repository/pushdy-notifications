...
/**
 * Returns the correct subdomain if 'https://subdomain.pushdy.com' or something similar is passed.
 */
...
function showHttpPopup() {
  ...
  if (subdomain.length == 0)
    subdomain = 's-pushdyexample';

  var domainPrefix = 'https://' + subdomain + '.pushdy.com/sdks/initPushdyHttp';
